...
- Bundle id **`com.bomi.inputmethod`** (MUST contain `inputmethod`).
- `InputMethodConnectionName` = **`com.bomi.inputmethod_Connection`** (exact; mismatch = silent load failure).
...
<dict>
  ...
  <key>CFBundleIdentifier</key><string>com.bomi.inputmethod</string>
  ...
  <key>InputMethodConnectionName</key><string>com.bomi.inputmethod_Connection</string>
  ...
  <dict>
    ...
    <dict>
      <key>com.bomi.inputmethod.korean</key>
      <dict>
        <key>TISInputSourceID</key><string>com.bomi.inputmethod.korean</string>
    ...
    <array>
      <string>com.bomi.inputmethod.korean</string>
    </array>
  </dict>
</dict>
</plist>
