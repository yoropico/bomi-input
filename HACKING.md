...
bomi-input의 코드를 직접 수정하고 싶은 분들을 위해 개발자 채널을 운영하고 있습니다.
...
``` sh
git clone https://github.com/yoropico/bomi-input.git  # 클론
cd gureum
make init
...
`OSX` 스킴을 빌드하면 의존성과 함께 bomi-input가 빌드됩니다.
...
> 어떠한 경우에도 Xcode에서 Run으로 bomi-input를 실행하거나 빌드한 bomi-input 앱을 직접 실행하면 **절대** 안됩니다.
...
설치 후에는 bomi-input가 사라질 수 있습니다. 언어 및 입력기 설정을 다시 열고 입력기를 설정해 줍니다.
